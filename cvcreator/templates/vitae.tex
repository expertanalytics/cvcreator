...
\BLOCK{if education}
  ...
  \begin{tabular}{LR}
    \BLOCK{for s in education}
      ...
      \BLOCK{if s.degree}{\bf \VAR{s.degree} in \BLOCK{if s.title}\VAR{s.title}\BLOCK{else}\VAR{s.topic}\BLOCK{endif}}\
        \BLOCK{else}\VAR{s.title} -- \VAR{s.description}\BLOCK{endif} \
      \BLOCK{if s.department or s.university or s.country} at \VAR{[s.department, s.university, s.country]|select()|join(", ")}.\BLOCK{endif} \
      \BLOCK{if s.thesis}Thesis title: ``\VAR{s.thesis}''.\BLOCK{endif} \
