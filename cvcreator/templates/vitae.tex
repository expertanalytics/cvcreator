...
\begin{adjustwidth}{-1.25cm}{-1.25cm}
    \begin{tabularx}{1\textwidth}{L X}
        \textbf{\VAR{programming_languages_title}: } & \VAR{programming_languages|join(", ")} \\
        \textbf{\VAR{tools_title}: } & \VAR{tools|join(", ")} \\
    \end{tabularx}
\end{adjustwidth}
...
\BLOCK{if project}
  ...
  \begin{tabularx}{1\textwidth}{X X X}
    \textbf{\VAR{s.title}} & \centering\textbf{\VAR{s.company}} & \hfill\textbf{\VAR{s.period}}\\
    \VAR{s.role}           &                          &                        \\
  \end{tabularx}
